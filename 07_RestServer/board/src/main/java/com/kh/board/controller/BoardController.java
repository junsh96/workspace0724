...
@RestController //모든 컨트롤러 메소드에 return 을 ResponseBody로 차리하여 데이터를 반환한다.
...
public class BoardController {
    ...
    @PostMapping
    public ResponseEntity<String> createBoard(BoardRequest.CteateDto request, MultipartFile upfile) throws IOException {
