...
<body>
    ...
    <p>
    	- 정적 include방식 => 컴파일시에 include를 수행해주기 때문에 컴파일 시점에 포함된 형태로 구성이 된다.(.jsp에서 .java가 될때 포함)
    </p>
    ...
    <h4>2.jsp표준 액션 태그를 이용한 방식(동적 include == 런타임 포함 형태)</h4>
    <jsp:include page="footer.jsp"/>
    <br>
    특징1. include 하고있는 페이지에 선언된 변수를 공유하지 않는다.
	=> include한 페이지의 변수를 신경쓰지 않고 페이지에서 변수를 사용할수 있다.<br>
