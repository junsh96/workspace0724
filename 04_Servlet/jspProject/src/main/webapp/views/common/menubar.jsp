...
<body>
    ...
    <c:choose>
    	<c:when test="${empty loginMember}">
	        ...
	        <script>
	        	function enrollPage() {
	        		//location.href = "jspProject//views/member/enrollForm.jsp"
	        		//내부 디렉터리 구조를 유추할 수 있는 단선가 될수 있기 때문에 디렉터리 구조를 url에 노출 하지 않고
	        		//서블릿을 이용한다.
	        		
	        		//location.href="/jspProject/enrollForm.me";
	        		location.href="${pageContext.request.contextPath}/enrollForm.me";
	        		//단순한 페이지 요청도 서블릿을 거쳐가도록 해야한다.
	        		//url에는 서버 요청을 위한 매핑값이 나타나도록.
	        	}
	        </script>
    	...
    	<c:otherwise>
	        ...
	        <div class="logout-area">
	            <b>${loginMember.memberName}님의 방문을 환영합니다.</b> <br>
	            <div>
	                <a href="">마이페이지</a>
