...
public class CompanyMenu {
	...
	public void itemMenu() {
		...
		while(whileVal) {
			...
			System.out.println("4. 발주 신청");
			System.out.println("5. 발주 승인");
			System.out.println("6. 비품 입고");
			System.out.println("7. 비품 사용 신청");
			System.out.println("8. 사용 승인");
			System.out.println("9. 비품 출고");
			System.out.println("10. 발주 요청 조회"); // 추가 필요
			System.out.println("11. 사용 요청 조회"); // 추가 필요
			System.out.println("12. 메인 메뉴");
	...
	public void deleteItem() {
		...
		System.out.println("삭제하실 비품 명을 입력해주세요.");
		System.out.println("※주 이미 발주가 된 상품은 삭제하실수 없습니다.※");
		String itemName = sc.nextLine();
	...
	public void empMenu() {
		...
		while(whileVal) {
			...
			System.out.println("4. 부서 조회");
			System.out.println("5. 직급 조회");
	...
	public void signEmp() {
		...
		em.setEmpJob(empJob);
		em.setSalary(salary);
		em.setBirtDate(LocalDate.parse(birtDate));
