...
public class ItemDao {
	 ...
	 * @return
	 */
	public int deleteItem(ItemVo i,Connection conn) {
		int result = 0;
		PreparedStatement pstmt = null;
	...
	/**
	 * 비품 삭제전 발주 요청이 들어갔는지 확인
	 * @param i
	 * @param conn
	 * @return
	 */
	public int checkDeleteItem(ItemVo i, Connection conn) {
		int result = 0;
		PreparedStatement pstmt = null;
		ResultSet rset = null;
		String sql = prop.getProperty("checkDeleteItem");
