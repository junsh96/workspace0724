...
public class CompanyController {
	 ...
	 * @param m
	 */
	public void signEmp(EmpVo em) {
		
		int result = cs.signEmp(em);
	 ...
	 * @param e
	 */
	public void loginEmp(EmpVo em) {
		String empId = em.getEmpId();
		List<EmpVo> result = cs.loginEmp(em);
	 ...
	 * @param e
	 */
	public void selectEmpList(EmpVo em) {
		
		List<EmpVo> result = cs.selectEmpList(em);
	 ...
	 * @param e
	 */
	public void updateEmp(EmpVo em) {
		
		int result = cs.updateEmp(em);
	 ...
	 * @param e
	 */
	public void deleteEmp(EmpVo em) {
		
		int result = cs.deleteEmp(em);
	...
	public void selectDept() {
		...
		List<DeptVo> result = cs.selectDept();
	...
	public void selectJob() {
		List<JobVo> result = cs.selectJob();
