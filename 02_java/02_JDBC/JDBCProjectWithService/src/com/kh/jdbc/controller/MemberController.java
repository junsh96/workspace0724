...
public class MemberController {
	...
	public void selectKeyWord(String keyword) {
		List<Member> list = ms.selectKeyWord(keyword);
	 ...
	 * @param map
	 */
	public void bulkINsertMembers(HashMap<String, Member> map) {
		
		int result = ms.bulkINsertMembers(map);
	 ...
	 * @param delUserId
	 */
	public void bulkDeleteMembers(String delUserId) {
		
		int result = ms.bulkDeleteMembers(delUserId);
