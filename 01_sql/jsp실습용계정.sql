...
DROP SEQUENCE SEQ_MNO; -- 회원번호 발생시킬 시퀀스
...
INSERT INTO MEMBER
VALUES (SEQ_MNO.NEXTVAL, 'admin', '1234', '관리자', '010-1111-2222', 'admin@kh.or.kr', '서울시 강남구 역삼동', NULL, '2022-02-10', '2022-02-10', 'Y');

INSERT INTO MEMBER
VALUES (SEQ_MNO.NEXTVAL, 'user01', 'pass01', '홍길동', '010-3333-2222', 'user01@kh.or.kr', '서울시 양천구 목동', NULL, '2023-01-10', '2023-01-10', 'Y');

INSERT INTO MEMBER
VALUES (SEQ_MNO.NEXTVAL, 'user02', 'pass02', '김개똥', '010-5424-3333', 'user02@kh.or.kr', '서울시 강서구', NULL, '2023-03-08', '2023-03-08', 'Y');
...
CREATE TABLE REPLY(
    ...
    FOREIGN KEY (REPLY_WRITER) REFERENCES MEMBER(MEMBER_NO)
);
